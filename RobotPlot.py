...
class RobotPlot:
    ...
    def PlotJointPost(self,_rb:robot , index):
        # get all link positions
        xLink1 = [_rb.pShoulder[0],_rb.pBase[0]]
        yLink1 = [_rb.pShoulder[1],_rb.pBase[1]]
        zLink1 = [_rb.pShoulder[2],_rb.pBase[2]]
        ...
        xTCPX = [jOrig[0],xEnd[0]]
        yTCPX = [jOrig[1],xEnd[1]]
        zTCPX = [jOrig[2],xEnd[2]]

        xTCPY = [jOrig[0],yEnd[0]]
        yTCPY = [jOrig[1],yEnd[1]]
        zTCPY = [jOrig[2],yEnd[2]]

        xTCPZ = [jOrig[0],zEnd[0]]
        yTCPZ = [jOrig[1],zEnd[1]]
        zTCPZ = [jOrig[2],zEnd[2]]


        # xTCPY = [jOrig[0][0],yEnd[0][0]]
        # yTCPY = [jOrig[0][1],yEnd[0][1]]
        # zTCPY = [jOrig[0][2],yEnd[0][2]]


        # xTCPZ = [jOrig[0][1],zEnd[0][0]]
        # yTCPZ = [jOrig[0][2],zEnd[0][1]]
        # zTCPZ = [jOrig[0][2],zEnd[0][2]]
